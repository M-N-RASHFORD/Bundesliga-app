                    ...
                    return  (
                        <ul>
                            <li key={video.id}>
                                <h3>{video.title}</h3>
                                <div>
                                    <img src={video.thumbnail} width="100px" height="100px" alt=""/>
                                    <p>{video.date}</p>
                                </div>
                                <div>
                                    <video height="window.height/2" width="window.height/2" controls>
                                        <source src={video.matchviewUrl.ogg} type="video.matchviewUrl/ogg"/>
                                    </video>
                                </div>
                            </li>
                        </ul>
